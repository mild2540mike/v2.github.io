...
<body>
  ...
  <div align="right"><button onclick="window.location.href='ceo_search.php'" type="button" class="btn btn-warning btn-lg"><b>ค้นหารายการ</b></button></div>
  <div class="table">
    <table class="table table-hover table-light">
      ...
      <tbody>
        ...
        $sql = "SELECT *, tb_doc.id_doc AS sid FROM tb_doc 
                    ...
                    Where tb_fix.fix_status='ชำรุด' AND tb_fix.status='รอผลจากผู้บริหาร' AND tb_dep.dep_status='ใช้งานปกติ' ORDER BY sid DESC";
        ...
        ?>
          <tr>
            ...
            <td align="center"><button class="btn btn-danger active btn-flat" onclick="window.location.href='ceo_update.php?id_fix=<?php echo $row["sid"]; ?>'"><i class="fa fa-eye"> รายละเอียด</i></button>
            </td>
          </tr>
        <?php
        }
        ...
        <?php
        //Join ฐานข้อมูล ในตาราง tb_fix กับ tb_type โดยใช้ sid กำหนด
        $sql = "SELECT SUM(tb_da.price),SUM(tb_fix.price_fix), SUM(tb_da.price), COUNT(tb_type.id_type), tb_doc.id_doc AS sid FROM tb_doc 
                            LEFT JOIN tb_da ON tb_da.id_item=tb_doc.id_doc
                            ...
                            Where tb_fix.fix_status='ชำรุด' AND tb_fix.status='รอผลจากผู้บริหาร' AND tb_dep.dep_status='ใช้งานปกติ'";
    ...
    <div>
      <button onclick="window.location.href='../index.php'" type="button" class="btn btn-danger">ออก</button>
    </div>
  </div>
