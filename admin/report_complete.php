...
<html>
  ...
  <body>
  <div class="p-3 mb-2 bg-dark text-white border-top" style="text-align: center;font-size: 25px;"><b>รายการประเมินผลแล้ว</b></div>
           <!-- link/link -->
          <div class="col-sm-6">
  ...
  <thead class="thead thead-dark">
    <tr>
      ...
      <th scope="col" style="text-align: center;" width="10%">มูลค่าคงเหลือ</th>
      <th scope="col" width="10%">สถานะ</th>
  ...
  <tbody>
    ...
    <?php
                    ...
                    WHERE tb_fix.fix_status='ชำรุด' AND tb_dep.dep_status='ใช้งานปกติ' AND NOT tb_fix.status='รอผลจากผู้บริหาร' ORDER BY sid DESC";
